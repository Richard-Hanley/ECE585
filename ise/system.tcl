# 
# Project automation script for ise 
# 
# Created for ISE version 13.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source /home/spenser/Desktop/ECE585/ise/system.tcl), then you can
...
set myProject "ise"
set myScript "/home/spenser/Desktop/ECE585/ise/system.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../src/cache.vhd"
   xfile add "../src/cache_ctl.vhd"
   xfile add "../src/constants.vhd"
   xfile add "../src/cpu.vhd"
   xfile add "../src/mem_elem.vhd"
   xfile add "../src/memory_ctl.vhd"
   xfile add "../src/top.vhd"
   xfile add "../testbench/t_top.vhd"
...
proc set_process_props {} {
   ...
   project set "Working Directory" "/home/spenser/Desktop/ECE585/ise"
